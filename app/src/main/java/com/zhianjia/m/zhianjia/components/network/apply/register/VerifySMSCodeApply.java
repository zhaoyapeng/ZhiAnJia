...
public class VerifySMSCodeApply extends BaseApply {
     ...
     * @param listener   验证结果监听
     */

    public VerifySMSCodeApply(String mobile, String verifyCode, int verifyType, HttpActionListener listener) {
        super(listener);
        this.mobile = mobile;
    ...
    protected String getUrl() {
        return Const.NetWork.BASE_URL + "check_sms";
    }
    ...
    protected String getHttpContent() {
        ...
        try {
            ...
            jsonObject.put("check_code", verifyCode);
